...
import { IOrganization, IPortalMenuItem, ITranslationText } from '@/interfaces/IOrganization';
import { cn } from '@/lib';
...
import {
    BookOpenIcon, CollectionIcon, LinkIcon, MapIcon, RefreshIcon, TranslateIcon
