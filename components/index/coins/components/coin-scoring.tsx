...
const tooltips = {
  developerActivity:
    'High developer activity indicates project growth and innovation. Score considers commits, active developers, and repositories.',
  socialSentiment:
    'Social sentiment reflects market perception and potential price movements. Based on mentions, engagement, and sentiment analysis.',
  walletActivity:
    'Wallet activity shows adoption and usage. Tracks active wallets, new wallets, and transaction patterns.',
  networkMetrics:
    'Network health indicators including validators, transactions, and growth metrics.',
  institutionalInterest:
    'Measures institutional adoption through major holders and investments.',
  ecosystemGrowth:
    'Tracks ecosystem expansion through partnerships, integrations, and new projects.',
  liquidityDepth: 'Assesses trading volume, market depth, and price stability.',
  protocolHealth:
    'Evaluates protocol security, decentralization, and reliability.',
};
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-sm text-slate-400">
                  {Object.entries(data)
                    .filter(
                      ([k]) => !['score', 'trend', 'description'].includes(k)
                    )
                    .map(([k, v]) => (
